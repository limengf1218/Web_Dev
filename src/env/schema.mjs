...
export const serverSchema = z.object({
  ...
  WECHAT_OPEN_APP_ID: z.string(),
  WECHAT_OPEN_APP_SECRET: z.string(),
  ALIBABA_CLOUD_ACCESS_KEY_ID: z.string(),
  ALIBABA_CLOUD_ACCESS_KEY_SECRET: z.string(),
  YUNXIN_APP_KEY: z.string(),
  YUNXIN_APP_SECRET: z.string(),
  EMAIL_HOST: z.string(),
  ...
  WECHAT_PAY_V3_SECRET: z.string(),
  WECHAT_PAY_MCHID: z.string(),
  WECHAT_PAY_APPID: z.string(),
  WECHAT_DONATE_AMOUNT: z.string(),
});
...
export const clientEnv = {
  ...
  NEXT_PUBLIC_CONTENT_DECTECTION_LOCATION:
    process.env.NEXT_PUBLIC_CONTENT_DECTECTION_LOCATION,
  ...
  NEXT_PUBLIC_CANNY_FEEDBACK_BOARD:
    process.env.NEXT_PUBLIC_CANNY_FEEDBACK_BOARD,
