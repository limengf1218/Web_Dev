          ...
          >
            <Tabs.List grow>
              <Tabs.Tab value="following">
                {t('Following')}{' '}
                <span>
                 ({abbreviateNumber(data?.followingCount ?? 0)})
                </span>
              </Tabs.Tab>
              <Tabs.Tab value="followers">
                {t('Followers')}{' '}
                <span>
                 ({abbreviateNumber(data?.followersCount ?? 0)})
                </span>
                </Tabs.Tab>
              {isSameUser && (
                ...
                {t('Hidden')}{' '}
                <span>
                ({abbreviateNumber(data?.hiddenCount ?? 0)})
                </span>
                </Tabs.Tab>
              )}
            </Tabs.List>
                        ...
                        <Paper p="xl" sx={{ width: '100%' }} withBorder>
                          <Center>
                            <Text size="lg" weight="bold">
                              {t('There are no following to show')}
                            </Text>
                          </Center>
                        </Paper>
                      </List.Item>
                    ...
                    {data.followers.length > 0 ? (
                      ...
                      <List.Item>
                        <Paper p="xl" sx={{ width: '100%' }} withBorder>
                          <Center>
                            <Text size="lg" weight="bold">
                              {t('There are no followers to show')}
                            </Text>
                          </Center>
                        </Paper>
                      </List.Item>
                      ...
                      {data.hidden.length > 0 ? (
                        ...
                        <List.Item>
                          <Paper p="xl" sx={{ width: '100%' }} withBorder>
                            <Center>
                              <Text size="lg" weight="bold">
                                {t('There are no hidden users to show')}
                              </Text>
                            </Center>
                          </Paper>
                        </List.Item>
