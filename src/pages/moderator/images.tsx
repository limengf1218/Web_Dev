  ...
  const reportMutation = trpc.report.bulkUpdateStatus.useMutation({
    ...
    onError(error) {
      showErrorNotification({
        title: t('Failed to update')as string,
        error: new Error(error.message),
        reason: t('Something went wrong while updating the reports. Please try again later.')as string,
      });
    },
  });
    ...
    <Container size="xl" py="xl">
      <Stack>
        ...
        >
          <Group noWrap spacing="xs">
            ...
            <PopConfirm
              ...
              withArrow
            >
              <ButtonTooltip label={t('Accept')} {...tooltipProps}>
            ...
            <PopConfirm
              ...
              withArrow
            >
              <ButtonTooltip label={t('Delete')} {...tooltipProps}>
        ...
        <Stack spacing={0} mb="lg">
          <Group>
            <Title order={1}>{t('Images Needing Review')}</Title>
            <SegmentedControl
              size="sm"
          ...
          <Text color="dimmed">
            {t('These are images that have been')}{' '}
            {viewingReported ? 'reported by users' : 'marked by our AI'} which needs further attention from the mods
          </Text>
        </Stack>
        ...
        {isLoading ? (
          ...
          <NoContent mt="lg" message={t('There are no images that need review')as string} />
        )}
