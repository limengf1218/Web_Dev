...
const { t } = useTranslation();
  ...
  const handleRefresh = () => {
    ...
    showNotification({
      id: 'refreshing',
      title: t('Refreshing'),
      message: t('Grabbing the latest data...'),
      color: 'blue',
    });
  };
      ...
      <Stack>
        ...
        >
          <Group noWrap spacing="xs">
            <ButtonTooltip label={t('Select all')} {...tooltipProps}>
              <ActionIcon variant="outline" onClick={handleSelectAll}>
                <IconSquareCheck size="1.25rem" />
              </ActionIcon>
            </ButtonTooltip>
            <ButtonTooltip label={t('Clear selection')} {...tooltipProps}>
            ...
            <PopConfirm
              ...
              withArrow
            >
              <ButtonTooltip label={t('Approve selected')} {...tooltipProps}>
            ...
            <PopConfirm
              ...
              withArrow
            >
              <ButtonTooltip label={t('Decline selected')} {...tooltipProps}>
                <ActionIcon variant="outline" disabled={!selected.length} color="red">
                  <IconBan size="1.25rem" />
                </ActionIcon>
              </ButtonTooltip>
            </PopConfirm>
            <ButtonTooltip label={t('Refresh')} {...tooltipProps}>
        ...
        <Stack spacing={0} mb="lg">
          <Title order={1}>{t('Tags Needing Review')}</Title>
          <Text color="dimmed">
            {t('These are images with moderation tags that users have voted to remove.')}
          </Text>
        </Stack>
        ...
        {isLoading ? (
          ...
          <NoContent mt="lg" message={t('There are no tags that need review')as string} />
        )}
