...
export default function Leaderboard() {
  ...
  return (
    <>
      <Meta
        title={`${selectedLeaderboard?.title ?? ''} Leaderboard | mikomiko`}
            ...
            <Stack spacing={0} maw={600} w="100%">
              ...
              <Group spacing={5}>
                ...
                <Popover withArrow>
                  ...
                  <Popover.Dropdown>
                    <Stack spacing={4}>
                      <Text weight={500}>{t('Rank is calculated based on:')}</Text>
                      <Code block color="blue">
                        {selectedLeaderboard?.scoringDescription}
                      </Code>
                      <Text color="dimmed" size="xs">
                        {t('Only the last 30 days are considered')}
                      </Text>
                    </Stack>
                  </Popover.Dropdown>
                </Popover>
              ...
              <Text color="dimmed" size="xs" mb="lg">
                ...
                {leaderboardResults[0]
                  ? dayjs(leaderboardResults[0].date)
                      .subtract(8, 'hours')
                      .format('MMMM D, YYYY h:mma')
                  : 'loading..'}
                {t('. Refreshes in:')}{' '}
                <Text span>
                  <Countdown endTime={dayjs().utc().endOf('day').subtract(8, 'hours').toDate()} />
                </Text>
              </Text>
