    ...
    <Popover withArrow>
      ...
      <Popover.Dropdown maw={350} w="100%">
        <Stack spacing={4}>
          ...
          <Divider label={t('Generation process')} labelProps={{ weight: 'bold' }} />
          <Chip.Group
            spacing={4}
            value={types}
          ...
          <Divider label={t('Excluded tags')} labelProps={{ weight: 'bold' }} />
          <MultiSelect
            placeholder={t('Select tags')as string}
