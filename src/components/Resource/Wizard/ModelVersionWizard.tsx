          ...
          <Link href={`/models/${modelVersion?.model.id}`} passHref>
            <Anchor size="xs">
              <Group spacing={4} noWrap>
                ...
                <Text inherit>{t('Back to')} {modelVersion?.model.name} page</Text>
              </Group>
            </Anchor>
          </Link>
          <Stepper
            ...
            size="sm"
          >
            <Stepper.Step label={editing ? t('Edit version') : t('Add Version')}>
              <Stack>
                <Title order={3}>{editing ? t('Edit version') : t('Add Version')}</Title>
