...
const { t } = useTranslation();
  ...
  const handleSave = () => {
    openConfirmModal({
      ...
      children:
        t('Files for this version are missing or still uploading. Your version will be saved as draft until all files are uploaded. We will notify you when it is ready to be published.'),
      onConfirm: () => {
