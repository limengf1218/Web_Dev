...
const { t } = useTranslation();
  ...
  const showPublishedNotification = async (modelId: number, modelVersionId?: number) => {
    ...
    showNotification({
      ...
      title: t('Version published'),
      color: 'green',
      styles: { root: { alignItems: 'flex-start' } },
      message: (
        <Stack spacing={4}>
          <Text size="sm" color="dimmed">
            {t('Your version has been published and is now available to the public.')}
          </Text>
        ...
        message: !stillUploading ? (
          <Stack spacing={4}>
            {isVersionPublished ? (
              <>
                <Text size="sm" color="dimmed">
                  {t('All files finished uploading.')}
                </Text>
                <Link
              ...
              <>
                <Text size="sm" color="dimmed">
                  {t(`Your files have finished uploading, let's publish this version.`)}
                </Text>
                <Text
                  variant="link"
                  size="sm"
              ...
              <>
                <Text size="sm" color="dimmed">
                  {t('Your files have finished uploading, but you still need to add a post.')}
                </Text>
                <Link
