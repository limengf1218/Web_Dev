...
const { t } = useTranslation();
  ...
  const handleDeleteArticle = (article: (typeof items)[number]) => {
    openConfirmModal({
      ...
      children: t('Are you sure you want to delete this article? This action is destructive.'),
      centered: true,
      labels: { confirm: t('Delete Article'), cancel: t("No, don't delete it") },
    ...
    <Stack>
          ...
          <tbody>
            ...
            {hasDrafts ? (
              ...
              <tr>
                <td colSpan={5}>
                  <Center py="md">
                    <NoContent message={t('You have no draft articles')as string} />
                  </Center>
                </td>
              </tr>
            )}
      ...
      {pagination.totalPages > 1 && (
        <Group position="apart">
          <Text>{t('Total')} {pagination.totalItems} {t('items')}</Text>
