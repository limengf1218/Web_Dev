    ...
    <IsClient>
      <Popover withArrow>
        ...
        <Popover.Dropdown maw={350} w="100%">
          <Stack spacing={0}>
            <Divider label={t('Model status')} labelProps={{ weight: 'bold' }} mb={4} />
            {user?.isModerator && (
              <Chip.Group
                spacing={4}
            ...
            <Divider label={t('Model types')} labelProps={{ weight: 'bold' }} />
            <Chip.Group
              spacing={4}
              value={filters.types ?? []}
            ...
            {showCheckpointType ? (
              <>
                <Divider label={t('Checkpoint type')} labelProps={{ weight: 'bold' }} />
                <SegmentedControl
                  my={5}
            ...
            <Divider label={t('Base model')} labelProps={{ weight: 'bold' }} />
            <Chip.Group
              spacing={4}
