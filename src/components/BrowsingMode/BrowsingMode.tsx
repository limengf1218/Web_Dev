...
const { t } = useTranslation();
  ...
  const options = [
    { label: t('Safe'), value: BrowsingMode.SFW },
    { label: t('My Filters'), value: BrowsingMode.NSFW },
    { label: t('Everything'), value: BrowsingMode.All },
  ];
  ...
  return (
    <Stack spacing={4}>
      {showBrowsingMode && (
        <>
          <Divider label={t('Browsing Mode')} labelProps={{ weight: 'bold' }} mb={-4} />
          <SegmentedControl
            data={options}
            value={browsingMode}
