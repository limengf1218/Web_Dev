  ...
  async () => {
    ...
    const updatePostMetrics = async () => {
      await dbWrite.$executeRawUnsafe(`
        ...
        ON CONFLICT ("postId", timeframe) DO UPDATE
          SET "commentCount" = "PostMetric"."commentCount" + EXCLUDED."commentCount", 
              "heartCount" = "PostMetric"."heartCount" + EXCLUDED."heartCount", 
              "likeCount" = "PostMetric"."likeCount" + EXCLUDED."likeCount", 
              "dislikeCount" = "PostMetric"."dislikeCount" + EXCLUDED."dislikeCount", 
              "laughCount" = "PostMetric"."laughCount" + EXCLUDED."laughCount", 
              "cryCount" = "PostMetric"."cryCount" + EXCLUDED."cryCount";
      `);
    ...
    const updateImageMetrics = async () => {
      ...
      ON CONFLICT ("imageId", timeframe) DO UPDATE
        SET "commentCount" = "ImageMetric"."commentCount" + EXCLUDED."commentCount", 
            "heartCount" = "ImageMetric"."heartCount" + EXCLUDED."heartCount", 
            "likeCount" = "ImageMetric"."likeCount" + EXCLUDED."likeCount", 
            "dislikeCount" = "ImageMetric"."dislikeCount" + EXCLUDED."dislikeCount", 
            "laughCount" = "ImageMetric"."laughCount" + EXCLUDED."laughCount", 
            "cryCount" = "ImageMetric"."cryCount" + EXCLUDED."cryCount";
    `);
