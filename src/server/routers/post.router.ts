...
import {
  createPostHandler,
  createSeedPostHandler,
  updatePostHandler,
  publishPostHandler,
  getPostHandler,
  addPostImageHandler,
  addSeedPostImageHandler,
...
export const postRouter = router({
  ...
  createSeed: protectedProcedure
    ...
    .use(isModerator)
    .mutation(createSeedPostHandler),
  publishSeed: protectedProcedure
    .input(postUpdateSchema)
    .use(isModerator)
    .mutation(publishPostHandler),
  addSeedImage: protectedProcedure
    .input(
      addPostImageSchema.extend({
        id: z.number().optional(),
        userId: z.number(),
    ...
    .use(isModerator)
    .mutation(addSeedPostImageHandler),
});
